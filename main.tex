...
En lo respectivo a la base de datos del backend, va a emplearse PostreSQL ya que, además de ser software libre, ofrece las funcionalidades necesarias para el proyecto.%Justificar brevemente la elección de PostgreSQL
...
Un repositorio será exclusivamente para la documentación, que será realizada utilizando \textit{LaTeX}. Todos los miembros del equipo modificarán el repositorio siguiendo un flujo de trabajo centralizado.
...
Para el reparto de las tareas se utilizarán las issues de \textit{GitHub}. Cada issue representará una funcionalidad o una tarea a desarrollar. Cuando un miembro del grupo vaya a realizar una de ellas deberá asignársela y cuando la haya completado deberá cerrarla. Además, esta herramienta permite realizar comentarios para facilitar la comunicación entre los miembros del equipo.
...
14 de abril, para una primera prueba de integración entre frontend y backend.
...
TODO TODO TODO
// Convertir las tareas en tareas de Gantt y establecer sus dependencias, ya están puestas en orden temporal pero muchas podrian ser ejecutadas paralelamente.
...
\begin{center}
    \begin{tabular}{ |l|l| }
        ...
        Para su reaundación, todos los participantes deberán ponerse de acuerdo. El sistema garantizará que todas las características de la partida se conserven tal y como se encontraban justo antes de la pausa. \\
        \hline
...
\begin{center}
    \begin{tabular}{ |l|l| }
        ...
        \textbf{Código} & \textbf{Descripción} \\
        \hline
        RNF-1 & El sistema permitirá jugar partidas contra otros usuarios, contra usuarios e inteligencia artificial o solamente contra inteligencia artifical. \\
        \hline
        ...
        \hline
        RNF-4 & La aplicación móvil funcionará únicamente en sistemas operativos Android. \\ % versiones mínimas????
        \hline
