...
En primer lugar, hay ocasiones en las que trabajar en pareja ya supone dificultades en cuanto a la planificación de tareas y la coordinación (trabajar al mismo tiempo, llevar el trabajo avanzado de manera similar, acordar las tareas a realizar…), por lo que una de las cosas que más se ha notado ha sido la cifra de seis personas como miembros de un equipo. Es la primera ocasión en el grado en Ingeniería Informática en la que los alumnos deben enfrentarse a la realización de un proyecto con tantos compañeros, y es algo que cuesta, sobre todo al principio. Como ya se ha mencionado, han surgido problemas de todo tipo: malentendidos sobre la ejecución de determinadas tareas, descoordinación en cuanto al avance del trabajo (en alguna ocasión el equipo de Backend terminó una primera versión de una característica y tuvo que esperar a los equipos de Frontend para probarla), problemas de compatibilidad de horarios a la hora de organizar reuniones, etc. Por este motivo, si a día de hoy se comenzase un nuevo proyecto de estas características, se intentaría organizar todo mucho más ordenadamente y desde el primer día, siguiendo de manera más estricta un diagrama de Gantt y programando reuniones con periodicidad.
Por otro lado, en lo referente a la implementación de la aplicación, se ha mencionado que se dejó el desarrollo de funcionalidades clave para el final, por lo que se concluye que se debería haber realizado una investigación de las tecnologías que se iban a necesitar, identificar las más complejas, investigar sobre ellas y comenzar a trabajar con ellas.
Más específicamente, el equipo de Backend se enfrentó a problemas como un mal diseño inicial del modelo de datos (se guardaba el estado completo del juego en la base de datos, lo que disminuía muchísimo la eficiencia), que hubo que cambiar posteriormente casi por completo. Esto se relaciona directamente con la conclusión obtenida anteriormente, es decir, un mal planteamiento inicial consigue aumentar la carga de trabajo final, representando una pérdida de tiempo y dinero si extrapolamos la situación a un ambiente laboral. De forma similar, se dedicó demasiado tiempo al diseño de la máquina de estados de simulación del juego (aproximadamente mes y medio), acarreando consecuencias similares.
Por último, se concluye que para verificar el correcto funcionamiento de una aplicación se debe someter a una batería de pruebas extensa y bien elaborada, ya que, en caso contrario, comienzan a salir bugs y errores inesperados en las etapas finales de desarrollo y eso conlleva que se pueda entregar un proyecto que no funcione correctamente.
