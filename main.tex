...
Debido a la elección de este lenguaje, se trabaja sobre ficheros '.tex' directamente, empleando GitHub para el trabajo colaborativo, al igual que con el resto del código del proyecto.

\subsubsection{Empleo de GitHub}
Para el control de versiones y configuraciones


\subsubsection{Desarrollo del backend}
El backend va a crearse en el lenguaje de programación GoLang, por lo que el grupo responsable del mismo ha optado por emplear el IDE GoLand de JetBrains, ya que está específicamente enfocado en este lenguaje. La elección de GoLang se debe a %Justificar brevemente la elección de GoLang
